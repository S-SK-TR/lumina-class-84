...
- `CLAUDE.md` dosyasındaki `Öğrenci Gelişim Takip Sistemi — Premium UI/UX Geliştirme Yol Haritası`, `Öğrenci Gelişim Takip Sistemi — Premium UI/UX Geliştirme Yol Haritası — Premium SaaS Uygulaması`, `[TECH_STACK]` gibi alanları gerçek değerlerle değiştir
